...
{
    thumbar->ChangeActType(ActTakePic);
    thumbar->ChangeActType(ActTakeVideo);
}

TEST_F(ThumbnailTest, addPath)
{
    thumbar->addPath(QString("/home/shicetu/"));
}
...
TEST_F(ThumbnailTest, onTrashFile)
{
    thumbar->onTrashFile();
}

TEST_F(ThumbnailTest, onShowVdTime)
{
    thumbar->onShowVdTime(QString("12345"));
}
